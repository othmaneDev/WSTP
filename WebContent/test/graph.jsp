...
<script src="js/EasyGraph.js"></script>
   	...
   	<div id="kinetic" style="height: 800px;  width: 1200px"></div>
	...
	<script>
		...
		new EasyGraph.Vertex({name:"${tag.name}", id:'tag${tag.idTag}',bg_color:'#AAF0D1',border_color:'#AAF0D1',radius:10});
		...
		<c:forEach var="wsta" items="${ wstaList }">
